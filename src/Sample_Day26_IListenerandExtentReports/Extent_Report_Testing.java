...
public class Extent_Report_Testing implements ITestListener{
...
@Override
   public void onStart(ITestContext context) {
       ...
       extent.setSystemInfo("Tester", "Users");
...
@Override
   ...
   public void onTestFailure(ITestResult result) {
    ...
    // Get driver instance from the failing test class
       ...
       driver = ((ExtentReport_DemoWebShop) testClass).driver;
